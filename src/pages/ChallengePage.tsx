...
const ChallengePage = () => {
  ...
  const { user, completeChallenge, hasCompletedAllChallenges } = useUser();
  ...
  }, [challenge, navigate, user.isRegistered, user.completedChallenges, completeChallenge, id]);
              ...
              <div className="bg-muted/50 rounded-lg p-4">
                ...
                <div className="bg-cyber-dark rounded-lg p-4 font-mono text-sm text-white overflow-auto">
                  <pre className="whitespace-pre-wrap">
                    {getCodeForChallenge(challenge.id)}
                  </pre>
                </div>
              </div>
            </TabsContent>
...
// Function to return code for each challenge
